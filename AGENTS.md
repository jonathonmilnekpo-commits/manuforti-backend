...
`Read HEARTBEAT.md if it exists (workspace context). Follow it. If anything is unclear or not covered, use your best judgment and move on. Do not infer or repeat old tasks from prior chats. If nothing needs attention, reply HEARTBEAT_OK.`
