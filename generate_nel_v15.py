#!/usr/bin/env python3
"""Generate Nel ASA Product 1 v15 — Full Pipeline"""
import sys
...
def gen_risk_gauge():
    ...
    ax.text(0, 1.25, 'Nel ASA - Overall Risk Assessment', ha='center', fontsize=18, fontweight='bold', color=M_NAVY)
    ax.text(0, 1.10, 'Hydrogen Electrolysers | Alkaline & PEM | 1 GW+ Manufacturing', ha='center', fontsize=12, color=M_GREY)
...
def gen_org_chart():
    ...
    ax.add_patch(parent)
    ax.text(8, 8.1, 'Nel ASA (OSE: NEL)', ha='center', fontsize=18, fontweight='bold', color='white')
    ax.text(8, 7.75, 'Oslo, Norway | Public Company | Founded 1927', ha='center', fontsize=10, color='#cccccc')
...
def gen_market():
    fig, ax = plt.subplots(figsize=(16, 9), facecolor='white')
    companies = ['Thyssenkrupp Nucera', 'Siemens Energy', 'John Cockerill', 'Nel ASA', 'ITM Power', 'Plug Power']
...
def gen_peer_risk():
    ...
    companies = ['Nel ASA', 'Siemens Energy', 'Thyssenkrupp', 'ITM Power', 'Plug Power', 'Bloom Energy']
...
print("Generating Nel ASA Product 1 v15...")
print("Step 1: Charts...")
visuals = {
...
add_text(s, 0.7, 3.5, 12, 0.6, 'Hydrogen Electrolysers | Alkaline & PEM | 1 GW+ Manufacturing', 18, False, (200,210,220))
...
add_text(s, 0.7, 4.55, 12, 0.4, 'NOK 1.6B Order Backlog | ~550 Employees | Oslo Bors Listed | Founded 1927', 14, False, (200,210,220))
...
snap = [('Supplier:', 'Nel ASA (OSE: NEL)'), ('Type:', 'Public Company'), ('Sector:', 'Hydrogen Electrolysers'), ('HQ:', 'Oslo, Norway'), ('Founded:', '1927'), ('Employees:', '~550'), ('Revenue:', 'NOK 1.3B (2023)'), ('Order Backlog:', 'NOK 1.6B'), ('Cash:', 'NOK 1.9B'), ('Manufacturing:', '1.5 GW Capacity')]
...
add_bullets(s, 8.7, 4.5, 4.3, 2.4, 'Leadership & Operations', ['CEO: Hakon Volldal', '  (appointed 2020)', '', 'HQ: Oslo, Norway', 'Manufacturing: Heroya (NO),', '  Wallingford (US)', '', 'R&D: GM partnership (PEM)'], 14, 11)
add_source(s); add_logos(s)

# S5: FINANCIAL HEALTH
print("  Slide 5: Financial Health")
s = prs.slides.add_slide(blank)
add_header(s, 'FINANCIAL HEALTH', 'Revenue & EBITDA Trajectory 2021-2024E | Listed on Oslo Bors')
...
metrics = [('2023 Revenue:', 'NOK 1,253M'), ('2024E Revenue:', 'NOK ~1,400M'), ('Revenue Growth:', '+21% YoY (Q3 2024)'), ('EBITDA:', 'NOK -90M (Q3 2024)'), ('Order Backlog:', 'NOK 1,614M (Q4 2024)'), ('Cash Balance:', 'NOK 1,876M'), ('Employees:', '~550'), ('Market Cap:', 'NOK ~15B (varies)')]
